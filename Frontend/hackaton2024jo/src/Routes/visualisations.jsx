  ...
  return (
    <>
      <div style={{ width: '100%', padding: '20px 0' }}>
        ...
        <div class="JO" style={{ backgroundColor: '#ffffffdb', width: '90%', margin: '5vh auto', padding: '20px', borderRadius: '25px' }} >
        ...
        <div class="performance" style={{ backgroundColor: '#ffffffdb', width: '90%', margin: '5vh auto', padding: '20px', borderRadius: '25px' }}>
        <Typography variant='h3' component='span' color={"#ab8600"}>
          Les Performances de la France aux Jeux Olympiques
        </Typography>
        
          <img style={{width:'100%'}} src='./EvolutionMedailleFranceParAn.png'></img>
          ...
          <img style={{width:'50%'}} src='./franceJO.png'></img>
        </div>
        <div class="JO1900" style={{ backgroundColor: '#ffffffdb', width: '90%', margin: '5vh auto', padding: '20px', borderRadius: '25px' }}>
        <Typography variant='h3' component='span' color={"#ab8600"}>

          Les Jeux Olympiques de Paris 1900 : Une Première pour les Femmes 
        </Typography>
        <Typography variant='body1' padding='15px' color={"#ab8600"}>
        ...
        <div class="participants" style={{ backgroundColor: '#ffffffdb', width: '90%', margin: '5vh auto', padding: '20px', borderRadius: '25px' }}>
        <Typography variant='h3' component='span' color={"#ab8600"}>

          Répartition Homme/Femme des Participants aux Jeux Olympiques 
        </Typography>
        <Typography variant='body1' padding='15px' color={"#ab8600"}>
          ...
          <img style={{width:'100%'}} src='./EvolutionGenreJO.png'></img>
        </div>
